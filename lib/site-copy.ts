...
export const siteCopy = {
  ...
  en: {
    ...
    hero: {
      label: 'POLARDOG STUDIO · INDEPENDENT GAME STUDIO',
      ...
      signature: 'GUIDED BY CURIOSITY',
      studioLabel: 'Curiosity. Passion. Shared imagination.',
      studioLink: 'What we believe',
    },
    works: {
      label: 'Our games',
